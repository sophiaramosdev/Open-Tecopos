            ...
            {current > stepIdx ? (
              <div  className="group flex w-full items-center">
                <span className="flex items-center px-6 py-4 text-sm font-medium">
                  <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-slate-700 group-hover:bg-slate-800">
              ...
              <div className="flex items-center px-6 py-4 text-sm font-medium" aria-current="step">
                <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border-2 border-slate-700">
                  <span className="text-slate-700">{`${stepIdx + 1}`}</span>
                </span>
                <span className="ml-4 text-sm font-medium text-slate-700">{step}</span>
              </div>
            ) : (
