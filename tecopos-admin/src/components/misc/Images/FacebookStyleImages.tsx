...
import { ImageLoad } from "../../../api/useServerMain";
import {
  SubmitHandler,
  useForm,
...
const FacebookStyleImages = ({
  ...
  switch (quant) {
    case 0:
      component = (
        <div className="flex flex-col items-center max-h-full w-full p-8">
          <svg
    ...
    case 1:
      component = (
        <div className="flex flex-col items-center max-h-full w-full p-1">
          <ImageComponent
    ...
    case 2:
      component = (
        <div className="grid grid-cols-2 items-center gap-1 max-h-full w-full p-1">
    ...
    case 3:
      component = (
        <div className="flex flex-col items-center justify-center max-h-full w-full gap-1">
            <ImageComponent
              src={previewDefault![0].src}
              hash={previewDefault![0].hash}
              className="flex h-full w-full justify-center items-center"
    ...
    case 4:
      component = (
        <div className="grid grid-rows-2 gap-1 max-h-full w-full">
    ...
    default:
      component = (
        <div className="flex flex-col gap-1 max-h-full w-full">
          <div className="grid grid-cols-2 items-center gap-1 h-full">
            {previewDefault!.slice(0, 2).map((item, idx) => (
              <ImageComponent
                key={idx}
      ...
      <div className={`${className ? className : ""} relative group`}>
        ...
        <div className="hidden group-hover:flex group-focus:flex flex-col absolute w-full h-full bg-gray-200 top-0 bg-opacity-70 p-1 items-center justify-center">
          ...
          <h1
            ...
            onClick={!disabled ? () => setImageModal(true) : undefined}
          >
            Configurar imágenes
          </h1>
        </div>
