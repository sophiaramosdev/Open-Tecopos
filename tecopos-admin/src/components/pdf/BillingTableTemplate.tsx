...
const BillingTableTemplate = ({
    ...
    const tableStyles = StyleSheet.create({
        ...
        col: {
            width: `${Math.floor((1 / (colNumber - 1)) * 100)}%`,
            display: "flex",
        ...
        colx2: {
            width: `${Math.floor(((1 / colNumber) * 100) * 2.7)}%`,
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
            justifyContent: "center",
        ...
        col_min: {
            width: `${Math.floor(((1 / colNumber) * 100) * 0.6)}%`,
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
            justifyContent: "center",
                            ...
                            return (
                                <View
                                    ...
                                    style={
                                        idx !== 0
                                            ? (idx === 1 || idx === 2 || idx === 3)
                                                ? { ...tableStyles.col_min, textAlign: "left" }
...
export default BillingTableTemplate;
