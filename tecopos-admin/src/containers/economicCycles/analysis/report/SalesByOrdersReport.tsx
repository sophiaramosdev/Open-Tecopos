...
export default function SalesByOrdersReport(props: any) {
    ...
    if (groupBy) {
        ...
        tableData.push({
            borderTop: true,
            payload: {
                'Fecha de creación': <p className="font-bold text-base text-gray-700">Totales</p>,
                "Comisiones": <p className="font-bold text-base text-gray-700">{totales?.comisiones}</p>,
                "Descuentos": <LineBreakComponentPlus payments={totales?.descuento} styles={'font-bold text-base text-gray-700'} />,
                "Contiene propina": <LineBreakComponentPlus payments={totales?.propina} styles={'font-bold text-base text-gray-700'} />,
                "Subtotal": <LineBreakComponentPlus payments={totales?.subtotal} styles={'font-bold text-base text-gray-700'} />,
                "Total Pagado": <LineBreakComponentPlus payments={paymentWayTotalResults} styles={'font-bold text-base text-gray-700'} iconCreditCard={'text-gray-700 translate-y-0.5'} iconCash={'text-gray-700 translate-y-1'} />,
                "Total": <LineBreakComponentPlus payments={totales?.total} styles={'font-bold text-base text-gray-700'} />,
                "Costos": <p className="font-bold text-base text-gray-700">{totales?.costos}</p>,
            },
        });
