...
const AccountingSummaryByOrdersReport = ({ areaSalesIncome, isLoading, ecoCycle }: { areaSalesIncome: AreaSalesIncomes[], isLoading: boolean, ecoCycle: EconomicCycle | null }) => {
      ...
      <div className="mb-16 w-full px-5">
        <div className="mx-auto w-full">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div
              /* id="slider" */
              className="w-fit h-full whitespace-nowrap scroll-smooth scrollbar-thin overflow-x-scroll"
            >
              {reports.map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className={`divide-gray-300 bg-white m-6 rounded-lg border px-10 max-w-lg border-gray-300 shadow-md inline-block p-2 ease-in-out duration-300`}
                  >
                                        ...
                                        .map((item) => (
                                          <div className="flex w-full items-start justify-between my-5">
                                            ...
                                            <div className="flex flex-col items-center justify-end w-2/3">
                                              ...
                                              {((item.paymentWay === "CASH" || item.paymentWay === null || item.paymentWay === undefined ) && item.amount > 0) && (
                                                <p className="my-1 text-gray-500">Efectivo</p>
                                              )}
                                            </div>
...
export default AccountingSummaryByOrdersReport
